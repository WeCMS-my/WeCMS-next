...
> 审查目标不是只看代码能否运行，而是确认代码是否符合架构、安全、AOT、Dapper.AOT、后端契约优先、AI 二期边界等硬约束。
...
```text
你是 WeCMS 数据库审查员。请审查 SQL migration 和 Dapper SQL。
