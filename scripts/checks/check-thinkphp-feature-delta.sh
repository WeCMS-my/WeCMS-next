...
backend_capability_files = {
    "auth login/refresh/logout/me": "backend/src/WeCms.Modules.Identity/Endpoints/AuthEndpointDefinition.cs",
    "account profile/security": "backend/src/WeCms.Modules.Identity/Endpoints/AccountProfileEndpointDefinition.cs",
    "account 2FA": "backend/src/WeCms.Modules.Identity/Endpoints/AccountTwoFactorEndpointDefinition.cs",
    "users": "backend/src/WeCms.Modules.Identity/Endpoints/UserEndpointDefinition.cs",
    "roles": "backend/src/WeCms.Modules.AccessControl/Roles/RoleEndpoints.cs",
    "permissions": "backend/src/WeCms.Modules.AccessControl/Permissions/PermissionManagementEndpoints.cs",
    "menus": "backend/src/WeCms.Modules.AccessControl/Menus/MenuEndpoints.cs",
    "departments": "backend/src/WeCms.Modules.Organization/Departments/DepartmentEndpoints.cs",
    "positions": "backend/src/WeCms.Modules.Organization/Positions/PositionEndpoints.cs",
    "dicts": "backend/src/WeCms.Modules.Configuration/Dicts/DictEndpoints.cs",
    "settings": "backend/src/WeCms.Modules.Configuration/Settings/SettingEndpoints.cs",
    "files": "backend/src/WeCms.Modules.FileCenter/Files/FileEndpoints.cs",
    "login logs": "backend/src/WeCms.Modules.Audit/Logs/LoginLogEndpoints.cs",
    "audit logs": "backend/src/WeCms.Modules.Audit/Logs/AuditLogEndpoints.cs",
    "security events": "backend/src/WeCms.Modules.Security/Events/SecurityEventEndpoints.cs",
    "security center": "backend/src/WeCms.Modules.Security/SecurityEndpoints.cs",
    "i18n": "backend/src/WeCms.Modules.Configuration/I18n/I18nEndpoints.cs",
}
...
frontend_capability_files = {
    ...
    "positions": "frontend/soybean-admin/src/views/system/positions/PositionsView.vue",
