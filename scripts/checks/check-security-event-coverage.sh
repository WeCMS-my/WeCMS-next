...
checks = {
    "cookie Origin rejection": [
        ("backend/src/WeCms.Modules.System/Auth/CookieAuthOriginValidation.cs", "auth.cookie_origin_rejected"),
    ...
    "login failure and rate limit": [
        ("backend/src/WeCms.Modules.System/Auth/AuthService.cs", "auth.login_failed"),
        ("backend/src/WeCms.Modules.System/Auth/LoginFailureLimiter.cs", "auth.login_rate_limited"),
        ("backend/tests/WeCms.Tests.Integration/Auth/AuthIntegrationTests.cs", "auth.login_rate_limited"),
    ],
    "2FA failure and replay": [
        ("backend/src/WeCms.Modules.System/Auth/AuthTwoFactorChallengeService.cs", "auth.two_factor_failed"),
        ("backend/src/WeCms.Modules.System/Auth/AuthTwoFactorChallengeService.cs", "auth.2fa_replay"),
    ...
    "rate limit hit": [
        ...
        ("backend/src/WeCms.Modules.System/Security/RateLimitRecords.cs", "rate_limit_hit"),
    ...
    "file upload rejection": [
        ("backend/src/WeCms.Modules.System/Files/FileService.cs", "file_upload_rejected"),
    ...
    "permission denied": [
        ("backend/src/WeCms.Modules.System/Permissions/PermissionEndpointFilter.cs", "permission_denied"),
        ("backend/src/WeCms.Persistence/Modules/System/Permissions/PermissionSecurityEventRepository.cs", "Classify(record.EventType"),
        ("backend/tests/WeCms.Tests.Unit/Permissions/PermissionEndpointFilterTests.cs", "permission_denied"),
    ],
    "sensitive settings change": [
        ("backend/src/WeCms.Modules.System/Settings/SettingService.cs", "security.setting_changed"),
        ("backend/tests/WeCms.Tests.Unit/Settings/SettingServiceTests.cs", "SecurityEventCount"),
    ],
    "high-risk 2FA reset": [
        ("backend/src/WeCms.Modules.System/Users/UserService.cs", "auth.user_2fa_reset"),
