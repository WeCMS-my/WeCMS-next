...
assert_contains "$fallback_output" "[1/37] dotnet restore"
assert_contains "$fallback_output" "[37/37] migration/seed smoke test"
...
assert_contains "$fallback_output" "check-no-controller"
assert_contains "$fallback_output" "check-minimal-api-endpoint-metadata"
assert_contains "$fallback_output" "check-no-system-god-module"
assert_contains "$fallback_output" "check-sqlsugar-boundary"
