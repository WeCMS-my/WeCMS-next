...
expected_routes = {
    ...
    "/system/positions": "views/system/positions/PositionsView.vue",
...
hardening_requirements = {
    ...
    "views/system/positions/PositionsView.vue": ["NDataTable", ":loading=", "#empty", "apiErrorMessage", "FormRules", "try {"],
