...
coverage = {
    ("post", "/api/v1/auth/login"): ("backend/src/WeCms.Modules.System/Auth/AuthService.cs", "RecordAuditLogAsync(", None),
    ("post", "/api/v1/auth/refresh"): ("backend/src/WeCms.Modules.System/Auth/AuthService.cs", "RefreshAuditAction", None),
    ("post", "/api/v1/auth/logout"): ("backend/src/WeCms.Modules.System/Auth/AuthService.cs", "LogoutAuditAction", None),
