...
public static partial class OpenApiExtensions
{
    ...
    [
        ...
        new OpenApiEndpointDescriptor("get", "/api/v1/system/security/rejections", true, SecurityPermissions.Status, null, nameof(SecurityRejectionSnapshotDto)),
        new OpenApiEndpointDescriptor("get", "/api/v1/system/security/rejections/metrics", true, SecurityPermissions.Status, null, nameof(SecurityRejectionMetricsDto)),
        ...
        new OpenApiEndpointDescriptor("get", "/api/v1/system/files/large-files/metrics", true, FilePermissions.List, null, nameof(FileUploadConcurrencyMetricsDto)),
