...
public static class AuthEndpointMappings
{
    public static RouteGroupBuilder MapAuthEndpoints(this WebApplication app)
    {
        ...
        var login = (RouteHandlerBuilder)group.MapPost("/login", static (LoginRequest request, HttpContext context) =>
            context.RequestServices.GetRequiredService<AuthEndpointHandlers>().LoginAsync(request, context));
        ...
        var refresh = (RouteHandlerBuilder)group.MapPost("/refresh", static (RefreshRequest request, HttpContext context) =>
            context.RequestServices.GetRequiredService<AuthEndpointHandlers>().RefreshAsync(request, context));
        ...
        var me = (RouteHandlerBuilder)group.MapGet("/me", static (HttpContext context) =>
