...
public sealed class PermissionChecker : IPermissionChecker
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var user = await connection.QuerySingleOrDefaultAsync<UserStatusRow>(new CommandDefinition("""
        ...
        var hasPermission = await connection.QuerySingleOrDefaultAsync<int>(new CommandDefinition("""
            SELECT 1
