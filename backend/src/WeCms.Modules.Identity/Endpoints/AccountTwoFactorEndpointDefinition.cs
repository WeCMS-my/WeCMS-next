...
public sealed class AccountTwoFactorEndpointDefinition : IEndpointDefinition
{
    public void MapEndpoints(IEndpointRouteBuilder endpoints)
    {
        ArgumentNullException.ThrowIfNull(endpoints);

        var group = endpoints.MapGroup("/api/v1/account/2fa")
            .WithEndpointModule("identity")
            .AuditWriteEndpoints("identity", "account-2fa")
