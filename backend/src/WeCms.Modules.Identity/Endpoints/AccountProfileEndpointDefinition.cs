...
public sealed class AccountProfileEndpointDefinition : IEndpointDefinition
{
    public void MapEndpoints(IEndpointRouteBuilder endpoints)
    {
        ...
        var group = endpoints.MapGroup("/api/v1/account")
            ...
            .AuditWriteEndpoints("identity", "account")
        ...
        group.MapPost("/avatar", UploadAvatarAsync)
            ...
            .RequireRateLimiting(IdentityEndpointRateLimitPolicyNames.FileUpload);
    ...
    private static async Task<IResult> GetAvatarAsync(HttpContext httpContext, IAccountProfileService service, IAuthClock clock, CancellationToken cancellationToken)
    {
        ...
        return Results.File(payload.Content, payload.MimeType, enableRangeProcessing: true);
    }
