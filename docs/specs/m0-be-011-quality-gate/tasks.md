# M0-BE-011 Quality Gate Tasks

- [x] Update `scripts/quality-gate-backend.sh` to 12 ordered steps.
- [x] Add OpenAPI export and OpenAPI check scripts into the gate.
- [x] Add `check-no-frontend-change.sh`.
