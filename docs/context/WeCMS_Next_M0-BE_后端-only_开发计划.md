...
实现 MySQL 连接、UnitOfWork、SqlSugar ORM 配置。
...
11. 禁止 dynamic 查询/返回。
12. 禁止 SELECT *。
13. 接入 SqlSugar ORM / MySqlConnector。
...
5. M0-BE-005：实现 Infrastructure Data / SqlSugar ORM。
