...
> 关联执行文档：`WeCMS_M0_工程骨架验证文档.md` 用于指导 M0 工程骨架搭建、AOT 发布、Dapper.AOT、OpenAPI、SoybeanAdmin 联通、认证最小闭环、权限元数据闭环与旧系统迁移 Spike。
...
DELIVERY-008：所有新增模块必须通过 Dapper.AOT 约束检查。
