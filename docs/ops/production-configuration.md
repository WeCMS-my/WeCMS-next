...
| `Database:LatestRequiredMigration` | Yes | Dev/Staging/Production | `000001_baseline_system_schema` | Public | Yes | Readiness reports migration unavailable when this version is absent from `sys_schema_migration` | Backend/Ops |
